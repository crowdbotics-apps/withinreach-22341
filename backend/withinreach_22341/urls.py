"""withinreach_22341 URL Configuration
...
admin.site.site_header = "WithinReach"
admin.site.site_title = "WithinReach Admin Portal"
admin.site.index_title = "WithinReach Admin"

# swagger
api_info = openapi.Info(
    title="WithinReach API",
    default_version="v1",
    description="API documentation for WithinReach App",
)
